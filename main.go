...
const (
	...
	ES_URL = "http://35.184.207.200:9200"      // Needs to update this bucket based on your gcs bucket name.
	BUCKET_NAME = "post-images-1993021"
)
func main() {
	// Create a client
...
func saveToGCS(ctx context.Context, r io.Reader, bucket, name string) (*storage.ObjectHandle, *storage.ObjectAttrs, error) {
	...
	fmt.Printf("post is saved to GCS: %s \n", attrs.MediaLink) //MediaLink is the Url
